...
joy1_edges = CannyEdgeDetection(joy1, N=9, sigma=2, percentageOfNonEdge=.8)
pointer1_edges = CannyEdgeDetection(pointer1, N=9, sigma=2, percentageOfNonEdge=.8)
lena_edges = CannyEdgeDetection(lena, N=9, sigma=2, percentageOfNonEdge=.8)
test1_edges = CannyEdgeDetection(test1, N=9, sigma=2, percentageOfNonEdge=.8)
