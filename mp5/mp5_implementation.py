...
joy1_edges = CannyEdgeDetection(joy1, N=5, sigma=1, percentageOfNonEdge=.85)
pointer1_edges = CannyEdgeDetection(pointer1, N=5, sigma=1, percentageOfNonEdge=.85)
lena_edges = CannyEdgeDetection(lena, N=5, sigma=1, percentageOfNonEdge=.85)
test1_edges = CannyEdgeDetection(test1, N=5, sigma=1, percentageOfNonEdge=.85)
